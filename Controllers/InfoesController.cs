...
namespace WebApplicationOne.Controllers
{
    public class InfoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InformationQuestion,Information")] Info info)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InformationQuestion,Information")] Info info)
        {
            if (id != info.Id)
            {
                return NotFound();
